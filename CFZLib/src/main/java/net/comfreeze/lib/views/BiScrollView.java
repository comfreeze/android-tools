 ...
 * allowing it to be larger than the physical display.  A BiScrollView
 ...
 * takes care of its own scrolling, so does not require a BiScrollView, but
 * using the two together is possible to achieve the effect of a text view
 * within a larger container.
 * <p/>
 * <p>BiScrollView only supports vertical scrolling.
 */
public class BiScrollView extends FrameLayout {
    ...
    /**
     * True if the user is currently dragging this BiScrollView around. This is
    ...
    public BiScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * @return Returns true this BiScrollView can be scrolled
     */
